...
cmd=("hyperfine" "--warmup" "2" "--runs" "10" "--time-unit" "millisecond" "--export-markdown" "temp_benchmarks.md")
...
echo "*Note: I made the benchmark to work with any programming language executed on Linux or WSL using hyperfine and the built-in GNU time command." > ./README.md